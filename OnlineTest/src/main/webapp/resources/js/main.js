...
"I take personal responsibility for all actions and outcomes.",
"I easily connect with a diverse group of people.",
"I act with empathy, showing concern towards all.",
"I keep an open mind to all possibilities.",
"I put to use the diverse strengths of people.",
"I establish processes for monitoring end-results.",
"I treat internal and external people with respect.",
"I constantly think differently.",
"I prevent people from losing time on non-value activities.",
"I Challenges set assumptions.",
"I work to identify process improvement opportunities.",
"I demonstrate learning from all experiences.",
"I gather support for new ideas to be implemented.",
"I am fair and unbiased with all people.",
"I positively accept new initiatives at work.",
"I balance emotional and caring responses with reason, logic, and reality in all decisions.",
"I simplify processes to focus on end-results.",
"I enable resources and authority for people to deliver.",
"I prioritise improvement areas to maximise impact.",
"I actively listen to people with undivided attention.",
"I identify areas worth investing resources in.",
"I persistently work to enhance customer experience.",
"I Hold self and team accountable to meet commitments.",
"I inspire people to out-perform and reach for more.",
"I accept and learn from failures.",
"I bring together people to work on common goals.",
"I stay solution focused, even with unclear or inadequate data.",
"I break silos at work that may be hampering results.",
"I remove bottlenecks for teams to deliver.",
"I champion the cause of internal and external customers.",
"I deliver as per agreed time and cost parameters.",
"I make fast decisions.",
"I strive for a balance between cost and derived value.",
"I seize opportunites, taking calculated risks when needed.",
"I show curiosity to learn new things.",
"I solicit inputs to get things done effectively.",
"I seek inputs from others in problem solving.",
"I ensure people get recognition for their efforts.",
"I support others in difficult times. ",
"I remain passionate to get closure, even under pressure.",
"I create opportunities to stretch and learn.",
"I go beyond immediate comfort zone to get things done."
];
...
var zmore=[`Innovation is a Core value you  highly identfy with.<br>
            ...
            <ol>
            <li>If you have an idea, don\â€™t think whether your idea is good or not, just contribute to â€œEurekaâ€�. You will be surprised at how many ideas were originally thought of as stupid, but later caught on. 
            <li>As a manager, Build a culture of asking questions. Every time you receive any output, ask the person â€œIs there a different and better way to do it?â€�
            `,
            ...
            <li>As a manager,Allow opportunities for people to mingle outside of work. Encourage â€œemployee clubsâ€�
            </ol>
            `,
            ...
            <li>As a manger, After every project/task is completed, conduct an After-Action Review or a â€˜Lessons Learnedâ€™ session. Capture it in a place where all can access it. 
            </ol>
            `,
...
var zless=[`Innovation  is a Core Value you should focus on exhibiting more.<br><br>
            ...
            <li>If you get an outlandish idea, log it into  Eureka  . As a manger, Build a culture of asking questions. Every time you receive any output, ask the person â€œIs there a different and better way to do it?â€�
            </ol>
           ...
           <strong>Derailers you must watch out for :</strong>
           <ul>
           <li>saying "Itâ€™s Not My Job" : When people know that something needs to be done to get the result, but thier behaviour is that of acute avoidance of getting involved. 
           <li>Confusion/Tell Me What to Do : citing  confusion as a way of alleviating themselves of their accountability. If they donâ€™t understand the problem or the situation, surely they canâ€™t be expected to do anything about it."
           </ul>
           `,
...
for(i=0;i<len;i++)
{
    ...
    cell3.innerHTML =  `<select id="${"testassess"+i}" name="${"q"+i}"><option disabled selected value="0">Select one of the options</option><option value="5">True of me</option><option value="4">Somewhat true of me</option><option value="3">Neutral</option><option value="2">Somewhat untrue of me</option><option value="1">Untrue of me</option></select>`;
}
...
//        }
    ...
    // });
    var formData = $('#Softskills').serializeArray();
    saveAnswer(JSON.stringify(formData));
...
function saveAnswer(formData) {
	var userId = $('#current_user_id').val();
	$.ajax({
        url: '/OnlineTest/saveAnswer',
        type: 'POST',
        data: {"form_data" : formData, "userId" : userId},
...
// Average calculator
function calc(){
    z[0]=(parseInt(toolans[0])+parseInt(toolans[4])+parseInt(toolans[8])+parseInt(toolans[10])+parseInt(toolans[13])+parseInt(toolans[15])+parseInt(toolans[17])+parseInt(toolans[19]))/8;
    z[1]=(parseInt(toolans[1])+parseInt(toolans[23])+parseInt(toolans[30])+parseInt(toolans[31])+parseInt(toolans[27])+parseInt(toolans[34])+parseInt(toolans[6])+parseInt(toolans[36]))/8;
    z[2]=(parseInt(toolans[2])+parseInt(toolans[37])+parseInt(toolans[5])+parseInt(toolans[14])+parseInt(toolans[28])+parseInt(toolans[26])+parseInt(toolans[7])+parseInt(toolans[20]))/8;
    z[3]=(parseInt(toolans[3])+parseInt(toolans[39])+parseInt(toolans[24])+parseInt(toolans[38])+parseInt(toolans[16])+parseInt(toolans[18])+parseInt(toolans[29]))/7;
    z[4]=(parseInt(toolans[12])+parseInt(toolans[25])+parseInt(toolans[35])+parseInt(toolans[41])+parseInt(toolans[22])+parseInt(toolans[11]))/6;
    z[5]=(parseInt(toolans[33])+parseInt(toolans[21])+parseInt(toolans[40])+parseInt(toolans[9])+parseInt(toolans[32])+parseInt(toolans[42]))/6;
}
...
var myChart = new Chart(ctx, {
    type: 'bar',
    data: {
        labels: ["Innovation","Accountability & Risktaking","Collaboration","Compassion & Care","Learning Agility","Speed"],
        datasets: [{
            label: 'CLASIC Score',
            data: z,
            backgroundColor: [
